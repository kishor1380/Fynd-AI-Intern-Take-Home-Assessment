...
def generate_summary(rating, review):
    ...
    prompt = f"""Create a detailed admin summary (15-25 words) that captures the KEY SPECIFIC POINTS from this customer review.
...
# Save feedback to Supabase (ONLY CHANGE FROM CSV!)
